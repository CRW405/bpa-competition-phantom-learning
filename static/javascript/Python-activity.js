...
function Lesson() {
    ...
    if (lesson == 1) {
        div.innerHTML =
            '<img src="static/Images/Python_Activity_S1.png" alt="no" width="100%" class = "py_img";>';
        document.getElementById("back_button").disabled = true;
    }

    else if (lesson == 2) {
        div.innerHTML =
            '<img src="static/Images/Python_Activity_S2.png" alt="no" width="100%" class = "py_img";>';
        document.getElementById("back_button").disabled = false;
    }

    else if (lesson == 3) {
        div.innerHTML =
            '<img src="static/Images/Python_Activity_S3.png" alt="no" width="100%" class = "py_img";>';

    }

    else if (lesson == 4) {
        div.innerHTML =
            '<img src="static/Images/Python_Activity_S4.png" alt="no" width="100%" class = "py_img";>';
    }

    else if (lesson == 5) {
        div.innerHTML =
            '<img src="static/Images/Python_Activity_S5.png" alt="no" width="100%" class = "py_img";>';
        ...
        div.innerHTML =
            '<img src="static/Images/Python_Activity_S6.png" alt="no" width="100%" class = "py_img";>';;

        // Changes to Finished Button
        // document.getElementById("next_to_finished").innerHTML = '<a href="/student.html"><button class="lesson_buttons" name="Finished Button">Exit <i class="fa-solid fa-door-open"></i> </button></a>'
