...
function answers() {
    if (confirm("Are you sure you want to submit? If so Press OK. Otherwise press cancel")) {
        calculate();
        div.innerHTML = '<div id="title_span"> <h1 id="quiz_title">Quiz Three: Python Results</h1><hr> <h1 id="quiz_results"> </h1></div>';
        document.getElementById("quiz_results").innerHTML = total + "%";
        document.getElementById("finish-to-exit").innerHTML = ' <a href="/student"><button class="lesson_buttons" name="Exit Test Button" id="exit_button" onclick="finish()"> EXIT </button></a>'
    }
...
function calculate() {
    ...
    // Q1
    if (answer_1 == "Option 2") {
        total += 10;
    }

    else if (answer_1 != "Option 2") {
        total += 0;
    };

    // Q2
    if (answer_2 == "Option 3") {
        total += 10;
    }

    else if (answer_2 != "Option 3") {
        total += 0;
    };

    // Q3
    if (answer_3 == "Option 2") {
        total += 10;
    }

    else if (answer_3 != "Option 2") {
        total += 0;
    };

    // Q4
    if (answer_4 == "Option 3") {
        total += 10;
    }

    else if (answer_4 != "Option 3") {
        total += 0;
    };

    // Q5
    if (answer_5 == "Option 2") {
        total += 10;
    }

    else if (answer_5 != "Option 2") {
        total += 0;
    };
    ...
    // Q7
    if (answer_7 == "Option 2") {
        total += 10;
    }

    else if (answer_7 != "Option 2") {
        total += 0;
    };

    // Q8
    if (answer_8 == "Option 2") {
        total += 10;
    }

    else if (answer_8 != "Option 2") {
        total += 0;
    };

    // Q9
    if (answer_9 == "Option 3") {
        total += 10;
    }

    else if (answer_9 != "Option 3") {
        total += 0;
    };
