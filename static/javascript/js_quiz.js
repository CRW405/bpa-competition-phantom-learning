...
function answers() {
    if (confirm("Are you sure you want to submit? If so Press OK. Otherwise press cancel")) {
        calculate();
        div.innerHTML = '<div id="title_span"> <h1 id="quiz_title">Quiz Two: Javascript Results</h1><hr> <h1 id="quiz_results"> </h1></div>';
...
function calculate() {
    ...
    // Q2
    if (answer_2 == "Option 4") {
        total += 10;
    }

    else if (answer_2 != "Option 4") {
        total += 0;
    };
